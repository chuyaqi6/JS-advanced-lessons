...
checkVarCount(1, 2);//结果：Successfully call the function
checkVarCount(1);//结果：The count of the parameters you passed into the function doesn't match the function definition.
...
li.sayHi();//
console.log(li.sex);//结果：M

Man.prototype.isStrong = true;
console.log(li.isStrong);//结果：true
